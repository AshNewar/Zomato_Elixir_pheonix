defmodule ZomatoWeb.LiveComponents.NavbarLive do
  ...
  def render(assigns) do
    ...
    <div id="nav_live" class="flex justify-between items-center mb-4 gap-4">
      ...
      <!-- Search Bar -->
      <div class="flex-grow relative"> <!-- Added relative position for dropdown placement -->
      ...
      <div class="search_results_container absolute px-4 w-full z-10"> <!-- Make the dropdown position absolute -->
